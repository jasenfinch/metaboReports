...
tibble(
  `S4 class` = c('Binalysis','MetaboProfile','Analysis','Assignment'),
  Package = c('[binneR](https://github.com/aberHRML/binneR)','[profilePro](https://github.com/jasenfinch/profilePro)','[metabolyseR](https://github.com/jasenfinch/metabolyseR)','[MFassign](https://github.com/jasenfinch/MFassign)')
) %>%
  kable()
```
